...
public class Main {
    ...
    static void eseguiCalcoli() {
        ...
        //ora che abbiamo il costruttore non ci serve più il metodo riempiOggetto
        //basta inserire i valori e il costruttore provvederà a inserire i dati dentro l'oggetto
        equazioni[0] = new OperazioniMatematiche('d', 45, 70);
        equazioni[1] = new OperazioniMatematiche('a', 120, 40);
        equazioni[2] = new OperazioniMatematiche('s', 42, 300);
        equazioni[3] = new OperazioniMatematiche('m', 6, 33);
